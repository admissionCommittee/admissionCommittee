 ...
 * <p>
 * Based on a script by <a href="mailto:stamhankar@hotmail.com">Sandeep V.
 * Tamhankar</a>
...
public class EmailValidator implements Serializable {
     ...
     * doesn't consider local addresses as valid.
     */
    private static final EmailValidator EMAIL_VALIDATOR_WITH_TLD = new
            EmailValidator(false, true);

    /**
     * Singleton instance of this class, which does
     * consider local addresses valid.
     */
    private static final EmailValidator EMAIL_VALIDATOR_WITH_LOCAL = new
            EmailValidator(true, false);
