...
final class DBInitializerUtil {
    ...
    static void initDatabase() {
        ...
        List<User> userList = new UserInitializerUtil().initEntities(
                16403, "C:/Users/Admin/Desktop/INITCURRENT/" +
                        "admissionCommittee/src/main/resources/db" +
        ...
        List<Faculty> facultyList = new FacultyInitializerUtil().initEntities
                (17, "C:/Users/Admin/Desktop/" +
                                "INITCURRENT/admissionCommittee" +
                                "/src/main/resources/db/FacultyInitData.txt",
                        "no output");
