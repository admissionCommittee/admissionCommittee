package com.github.admissionCommittee.util.validate.org.apache.commons
        .validator.routines;
 ...
 * <p>
 * <p>
 * (<b>NOTE</b>: This class does not provide IP address lookup for domain
 * names or
...
public class DomainValidator implements Serializable {
    ...
    // 1123)
    private static final String DOMAIN_LABEL_REGEX = "\\p{Alnum}" +
            "(?>[\\p{Alnum}-]*\\p{Alnum})*";
     ...
     */
    private static final DomainValidator DOMAIN_VALIDATOR = new
            DomainValidator(false);
    /**
     * Singleton instance of this validator, which does
     * consider local addresses valid.
     */
    private static final DomainValidator DOMAIN_VALIDATOR_WITH_LOCAL = new
    ...
    private static final String[] INFRASTRUCTURE_TLDS = new String[]{
            ...
            "root"                // diagnostic marker for non-truncated root
            // zone
    };
    private static final String[] GENERIC_TLDS = new String[]{
            ...
            "edu",                // accredited postsecondary US education
            // entities
    ...
    private static final String[] COUNTRY_CODE_TLDS = new String[]{
            ...
            // official domain for Los Angeles)
            "lb",                 // Lebanon
            "lc",                 // Saint Lucia
            "li",                 // Liechtenstein
            "lk",                 // Sri Lanka
            ...
            "pn",                 // Pitcairn Islands
            "pr",                 // Puerto Rico
            "ps",                 // Palestinian territories (PA-controlled
            ...
            "sh",                 // Saint Helena
            "si",                 // Slovenia
            "sj",                 // Svalbard and Jan Mayen Islands Not in
            // use (Norwegian dependencies; see .no)
            "sk",                 // Slovakia
            "sl",                 // Sierra Leone
            "sm",                 // San Marino
            "sn",                 // Senegal
            ...
            "ye",                 // Yemen
            "yt",                 // Mayotte
            "yu",                 // Serbia and Montenegro (originally
            // Yugoslavia)
            "za",                 // South Africa
            "zm",                 // Zambia
            "zw",                 // Zimbabwe
    ...
    private static final List INFRASTRUCTURE_TLD_LIST = Arrays.asList
            (INFRASTRUCTURE_TLDS);
    private static final List GENERIC_TLD_LIST = Arrays.asList(GENERIC_TLDS);
    private static final List COUNTRY_CODE_TLD_LIST = Arrays.asList
            (COUNTRY_CODE_TLDS);
